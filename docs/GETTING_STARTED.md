...
1. Go to `https://auditagent.cloud` and sign in with your work email
...
3. Store it as an environment variable (`AUDITAGENT_API_KEY`) wherever your
...
1. In **Settings**, follow the "Connect Slack" steps (this asks your admin
   to install the AuditAgent Slack app once per workspace).
...
questionnaire (PDF, DOCX, or plain text). AuditAgent parses out individual
...
The **SOC 2** page maps common Trust Services Criteria to what AuditAgent
